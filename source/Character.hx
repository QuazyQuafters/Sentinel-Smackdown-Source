...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf-azael':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('characters/GF_Azael_ass_sets');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'bf-fisch':
				var tex = Paths.getSparrowAtlas('characters/BoyFriend_Fischeran_Assets', 'shared');
				frames = tex;
			...
			case 'parents-christmas':
				...
				playAnim('idle');
			case 'freshie':
				// BITCH BE FOR REALLLLLLL..... OKAY! TUNDRA RANGER STEAL!!!!! 
				tex = Paths.getSparrowAtlas('characters/Ashiin_Assets', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'Ashiin idle', 24);
				animation.addByPrefix('singUP', 'Ashiin up', 24);
				animation.addByPrefix('singRIGHT', 'Ashiin right', 24);
				animation.addByPrefix('singDOWN', 'Ashiin down', 24);
				animation.addByPrefix('singLEFT', 'Ashiin left', 24);
				animation.addByPrefix('agility', 'Ashiin agility', 24);

				addOffset('idle');
				addOffset("singUP", -6, 10);
				addOffset("singRIGHT", -99, -14);
				addOffset("singLEFT", 12, 2);
				addOffset("agility", 12, 2);
				addOffset("singDOWN", 0, -88);

				playAnim('idle');
			case 'synapse':
				// BITCH BE FOR REALLLLLLL..... OKAY! TUNDRA RANGER STEAL!!!!! 
				tex = Paths.getSparrowAtlas('characters/FreshieHacker_Assets', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'Ashiin idle', 24);
				animation.addByPrefix('singUP', 'Ashiin up', 24);
				animation.addByPrefix('singRIGHT', 'Ashiin right', 24);
				animation.addByPrefix('singDOWN', 'Ashiin down', 24);
				animation.addByPrefix('singLEFT', 'Ashiin left', 24);
				animation.addByPrefix('BANNED', 'Ashiin banned', 24);
	...
	public function dance(forced:Bool = false)
	{
		if (!debugMode)
		{
			switch (curCharacter)
			{
				case 'gf' | 'gf-christmas' | 'gf-car' | 'gf-pixel' | 'gf-azael':
